...
*/      
        ...
        wp_enqueue_script( 'cl-builder', cl_asset_url('js/cl-builder.js'), array('jquery', 'wp-util', 'backbone', 'underscore', 'customize-preview', 'shortcode', 'jquery-ui-sortable', 'jquery-ui-droppable') );
